...
stopwords = {   'he', 'no', 'do', 'wasn', 'between', 't', 'm', 'was', 'with', 'other', 'down', 'above', 'does', 'they',
                 ...
                 "wasn't", 'it', 'y', 'just', 'our', 'him', 'for', 'assert'}
...
if __name__ == '__main__':
    ...
    final1 = list()
    for i in list_1:
        word = re.sub(r'less|ship|ing|les|ly|es|ic|ora|ous|ble|able|s|ed|tional|ization|ism|tive|ness|ent|ment|ize|ive|ici|al', '', i)
        final1.append(word)
    final2 = list()
    for i in list_2:
        word = re.sub(r'less|ship|ing|les|ly|es|ic|ora|ous|ble|able|s|ed|tional|ization|ism|tive|ness|ent|ment|ize|ive|ici|al', '',i)
